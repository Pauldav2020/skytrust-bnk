    ...
    <div class="reg-row">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-container">
                <a href="index">
                    <img src="./assets/images/bitrust.png" alt="Bank Logo">
                </a>
                <h2>Sign Up</h2>
                <h5>SECTION ONE</h5>
            ...
            <div class="form-container">
                ...
                <label for="" style="float: left; margin-left: 80px; height:10px; font-weight: bold">Date of Birth</label>
                <div class="dob-container">
                    ...
                    <div class="day-cont">
                        <select name="day" id="day" class="day">
                            ...
                            <?php
                                for($d= 1; $d <=31; $d++){?>
                                    <option value="<?=$d?>" <?php echo(isset($_P0ST['day']) && $_P0ST['day'] == $d)? "selected" : ""?>><?=$d?></option>
                              <?php  }
                            ?>
                        </select>
                        ...
                        <select name="month" id="month" class="month">
                            ...
                            <?php
                                ...
                                for($m = 0;$m<count($months);$m++){?>
                                    <option value="<?=$months[$m]?>" <?php echo(isset($_P0ST['month']) && $_P0ST['month'] == $month)? "selected" : ""?>><?=$months[$m]?></option>
                               <?php }
                            ?>
                        </select>
                    ...
                    <div class="year-cont">
                        <select name="year" id="year" class="year">
                            ...
                            <?php
                                for($y = 1920; $y<=2050;$y++){?> 
                                    <option value="<?=$y?>" <?php echo(isset($_P0ST['year']) && $_P0ST['year'] == $y)? "selected" : ""?>><?=$y?></option>
                            <?php }
                            ?>
                        </select>
                        <span class="d-block text-danger"><?=$date_er?></span>
                ...
                <input type="tel" name="phone" id="phone"   placeholder="Phone Number" value="<?=$phone?>" onkeypress="return (event.charCode != 8 && event.charCode ==0 || (event.charCode >=48 && event.charCode <=57))" required>
