    ...
    <div class="dash-container">
        <div class="row">
            <div class="grid-1">
                ...
                <ul class="agent">
                    <a href="mailto:skytrustsupport@skyncgroup.com">skytrustsupport@skyncgroup.com</a>
                    <p>Banking Agent</p>
                </ul>
                ...
                <ul class="accounts">
                    <h4>MY ACCOUNT</h4>
                    <li>
                        <a href="dashboard" class="dash-active" id="page1"><span class="material-symbols-outlined">house </span> HOME DASHBOARD</a>
                    </li>
                    <li>
                        <a href="personal_infos"> <span class="material-symbols-outlined"> manage_accounts </span> ACCOUNT DETAILS</a>
                    </li>
                    <li>
                ...
                <ul class="messages">
                    <h4>MESSAGES</h4>
                    <li>
                        <a href="chat_us"><span class="material-symbols-outlined">mail</span> NEW MESSAGE (<span class="showNotify"></span>) </a>
                    </li>
                    <!-- <li>
            ...
            <div class="grid-2">
                    ...
                    <div class="users">
                        <div class="notification">
                            <a href="chat.php?notification" style="cursor: pointer">
                                (<span class="showNotify"> </span>) <span class="material-symbols-outlined">notifications</span>
                            </a>
                        </div>
                        <!-- <div class="profile">
                        ...
                        <div class="profile">
                            ...
                            <!-- <i class="fa-solid fa-user" style="width: 70px; height:70px;border-radius: 100%; background-color: #ddd; padding: 10px 15px 0 0;font-size: 40px;margin-right: 5px"></i> -->
                                <span class="material-symbols-outlined" style="width: 70px; height:70px;border-radius: 100%; background-color: #ddd; padding: 10px 15px;font-size: 40px; margin-right: 5px">person</span><span><?=$fetchReg['Names']?></span>
                            <?php }else{?>
                                <img  src="./<?=$imgUploaded?>" alt="image" style="width:40px; height:40px;border-radius: 100%; margin-right: 5px"> <span><?=$fetchReg['Names']?></span>
                        <?php }
                        ?>
                    </div>
                    </div>
                ...
                <div class="account-info">
                    <div class="welcome-container">
                        <div class="welcome">
                            <h4 style="color: green">Welcome, <span style="color: #000"><?=$fetchReg['Names']?></span></h4>
                    ...
                    <div class="image-container">
                            ...
                            if ($imgUploaded == "NULL") { ?>
                                <div class="images" style="margin-right:20px">
                                    ...
                                    <span class="material-symbols-outlined" style="width: 70px; height:70px;border-radius: 100%; background-color: #ddd; padding: 10px 15px;font-size: 40px; margin-left: 45px">person</span>
                                    <!-- <i class="fa-solid fa-camera" ></i> -->
                                    <span class="material-symbols-outlined" id="upted" onclick="openFile()" style="margin-left: -17px; cursor: pointer;color: red;font-weight: bold ">photo_camera</span>
                                    <span class="text-danger text-block"><?= $file_er ?></span>
                                </div>
                            <?php } else { ?>
                                <span class="material-symbols-outlined change" id="upted"  onclick="openFile()">photo_camera</span>
