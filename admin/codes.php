                        ...
                        <div class="container">
                            <div class="shadow-lg bg-light mx-auto p-4 mt-5 w-50">
                                ...
                                <select name="billing" id="" class="form-control my-3" required>
                                    ...
                                    <option value="ttp"<?php echo(isset($_POST['billing']) && $_POST['billing'] == "ttp")? "selected" : "";?>>TTP_code</option>
                                    <option value="vat" <?php echo(isset($_POST['billing']) && $_POST['billing'] == "vat")? "selected" : "";?>>VAT_code</option>
                                    <option value="dtp" <?php echo(isset($_POST['billing']) && $_POST['billing'] == "dtp")? "selected" : "";?> >DTP_code</option>
                                </select>
